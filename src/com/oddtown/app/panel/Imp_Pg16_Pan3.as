package com.oddtown.app.panel
{
	...
	public class Imp_Pg16_Pan3 extends PanelImp
	{
		private static const ID:String="Imp_Pg16_Pan3";
		private static const FLAG_CHAO:String="flagChao";
		private static const FLAG_MASON:String="flagMason";
		private var panel:Pg16_Pan3;
		public function Imp_Pg16_Pan3()
		{
			super();
		}
		...
		private function onBtnClick(e:MouseEvent):void
		{
			...
			try {
				...
				if(page)
				{
					page.pan1.chaoClick.visible=false;
					TweenLite.to(page.pan1.chao,1,{alpha:0,onComplete:hideFolder});
				}
			} catch(e:Error) {
				trace(e);
			}
